...
impl Preferred {
    ...
    pub fn legacy_compatibility() -> Preferred {
        ...
        Preferred {
            kex: Cow::Owned(kex),
            host_key_certificates: Preferred::DEFAULT.host_key_certificates,
            key: Preferred::DEFAULT.key,
...
mod tests {
    ...
    /// algorithm russh does not implement (`unknown-kex@example.invalid`) — while
