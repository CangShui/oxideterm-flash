...
impl FontFamily {
    pub fn terminal_family_name(self, custom: &str) -> String {
        ...
        match self {
            ...
            // An empty custom selection resolves to the platform monospace
            // default because no bundled font ships anymore.
            Self::Custom => default_terminal_font_family().to_string(),
        }
    }
}

/// Cross-platform system monospace used when no explicit family resolves.
pub const fn default_terminal_font_family() -> &'static str {
