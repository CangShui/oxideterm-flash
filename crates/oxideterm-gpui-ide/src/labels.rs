...
impl Default for IdeLabels {
    fn default() -> Self {
        Self {
            ...
            agent_optin_desc: "oxideterm-flash can deploy a lightweight agent (~2 MB) to the remote host for enhanced IDE features. The agent runs inside your existing SSH connection and makes no external network calls.".into(),
