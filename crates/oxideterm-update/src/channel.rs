...
pub const STABLE_UPDATE_ENDPOINT: &str =
    "https://github.com/CangShui/oxideterm-flash/releases/latest/download/latest.json";
pub const BETA_UPDATE_ENDPOINT: &str =
    "https://github.com/CangShui/oxideterm-flash/releases/download/updater-beta/latest.json";
