...
#[derive(Debug, Args)]
#[command(
    long_about = "Apply a multi-step OxideTerm CLI plan. The plan can combine settings import and connections snapshot import in one dry-run or confirmed write."
)]
#[command(
