...
use crate::{
    ...
    GoToTab9, NewConnection, NewTerminal, NextTab, OpenSettings, PaletteBroadcast,
    PaletteEventLog, Paste, PrevTab, Quit, ShellLauncher, ShowShortcuts, SplitHorizontal,
    SplitNavLeft, SplitNavRight, SplitVertical, TerminalClearScreen, TerminalFreeTypeMode,
    TerminalRecording, ToggleFullscreen, ToggleSidebar,
    ZenMode,
};
