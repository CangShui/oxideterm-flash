...
pub(super) const OXIDE_IMPORT_FOOTER_BODY_INPUTS: [ConnectionWorkspaceInput; 1] =
    [ConnectionWorkspaceInput::OxideImportPassword];
pub(super) const OXIDE_EXPORT_FOOTER_BODY_INPUTS: [ConnectionWorkspaceInput; 3] = [
...
pub(super) fn oxide_import_footer_body_inputs(
    dialog: &OxideImportDialogState,
) -> &'static [ConnectionWorkspaceInput] {
