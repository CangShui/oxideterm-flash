...
impl WorkspaceApp {
    ...
    fn version_migration_page(&self, compact: bool, cx: &mut Context<Self>) -> AnyElement {
        match self.version_migration.step {
            ...
            1 => self.version_migration_gpui_page(compact),
            2 => self.version_migration_visual_page(compact, cx),
            3 => self.version_migration_features_page(compact),
