...
use oxideterm_connections::{
    ...
    DEFAULT_SSH_CONNECT_TIMEOUT_SECONDS, RemoteDesktopProfile, SavedAuth, SavedConnection,
    SavedProxyHop, SavedUpstreamProxyProtocol, SerialProfile, SshAlgorithmPreferences,
...
pub(in crate::workspace) fn next_connection_field(
    ...
    if transport == NewConnectionTransport::StandaloneSftp {
